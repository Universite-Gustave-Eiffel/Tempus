...
public:
    ...
    typedef RoadGraph graph_type;
    typedef AutomatonGraph automaton_type;
    typedef typename RoadGraph::vertex_descriptor GVertex;
    typedef typename RoadGraph::edge_descriptor GEdge; 
    typedef typename RoadGraph::out_edge_iterator GEdgeIterator;
    ...
    // graph traits :
    typedef std::pair< GVertex, typename AutomatonGraph::vertex_descriptor > vertex_descriptor;
    ...
    public:
        out_edge_iterator() :
            ...
            q( 0 )
        {}
        out_edge_iterator( const RoadGraph& graph, const AutomatonGraph& automaton, vertex_descriptor source ) :
            graph_( &graph ),
        ...
        void update_edge() {
            ...
            typename AutomatonGraph::vertex_descriptor qp;
	    bool found;
	    boost::tie( qp, found ) = find_transition( *automaton_, q, *out_edge );
    ...
    private:
        ...
        const AutomatonGraph* automaton_;

        typename AutomatonGraph::vertex_descriptor q;
        GVertex u;
        GEdgeIterator out_edge, out_edge_end;
        edge_descriptor edge_;
    };

    CombinedGraphAdaptor( RoadGraph& graph, AutomatonGraph& automaton ) :graph_( graph ), automaton_( automaton ) {}

    RoadGraph graph_;
    AutomatonGraph automaton_;
};
