...
A detailed description of the [C++ API documentation](ifsttar.github.io/Tempus/api/index.html) can be found (generated by Doxygen)

Developer manual
----------------

A [developer manual](user/Manuel_utilisation.odt) is also available (French only for now).
