...
Python bindings are provided thanks to the boost::python library.

You can have a look at some [unit tests](../python/pytempus/tests.py) or the [standalone Tempus application](../python/pytempus/standalone) rewritten in Python. It allows to use graph plugins written in Python (see [this example](../python/pytempus/astar_plugin))
